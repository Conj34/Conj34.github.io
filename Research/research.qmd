...
If you want an overlook of my research so far, you can give a look at the introduction to my PhD Thesis: [Colours, Giants, and Games](../Documents_files/Theses/Colours_Giants_and_Games.pdf).
...
-   **Methodology for carbon credit assessment**<br> with A. Perrella, G. Marastoni (2026++)
-   **Partition universality for hypergraphs** <br> with P. Allen, J. Böttcher (2026++)
-   [**A Transference Principle and a Counting Lemma for Sparse Hypergraphs**](../Documents_files/Secret_papers/A_Transference_Principle.pdf)<br>with P. Allen, J. Böttcher, J. Lada (2026+)
-   **Best Response Dynamics for Random Games**<br> with G. Ashkenazi-Golan, E. Plumb, J. Skokan (2026++)

[**Submitted**]{style="color:green;font-size:20.0pt"}

-   [**No-Regret Dynamics Do Not Eliminate Dominated Strategies**](../Documents_files/Secret_papers/projected_gradient_and_dominated_strategies.pdf).<br> with G. Ashkenazi-Golan, E. Plumb, B. Tarbush<br> *Submit. EC2026* 

-   [**Simultaneous Best-Response Dynamics in Random Potential Games**](https://arxiv.org/abs/2505.10378).<br> with G. Ashkenazi-Golan, E. Plumb<br> *Submit. to ICML2026*<br>Paper with [code](../Research/SBRD.ipynb)
...
[**To Appear**]{style="color:green;font-size:20.0pt"}

-   [**Graphs with large minimum degree and no short odd cycles are 3-colourable**](https://arxiv.org/abs/2302.01875).<br> with J. Böttcher, N. Frankl, O. Parczyk, J. Skokan<br>*To appear Comb. Theory*

[**Published**]{style="color:green;font-size:20.0pt"}

-   [**Dirac's theorem for graphs of bounded bandwidth**](https://www.combinatorics.org/ojs/index.php/eljc/article/view/v33i1p21).<br> with A.E. Díaz, P. Gupta, O. Parczyk, A. Sgueglia<br> The Electronic Journal of Combinatorics. Vol 33, Iss. 1 (2026), P1.22
...
|-------------------|------------------|------------------|------------------|
| [Product-free subsets of $[n]$](../Documents_files/Presentations/Product_Schur_Triples___Slides.pdf) | Nov '25 | Coloquio de Matematica | Uniandes, Bogota |
| [Product-free subsets of $[n]$](../Documents_files/Presentations/Product_Schur_Triples___Slides.pdf) | Oct '23 | LSE Seminar | London |
...
| What | When | Where | Why |
|------------------|------------------|------------------|------------------|
| [Colours, Giants, and Games](../Documents_files/Theses/Colours_Giants_and_Games.pdf) | 2025 | LSE | PhD Thesis |
...
|------------|------------|------------|------------|------------|------------|
| Coloquio | Oct '25 | Bogota | Uniandes | Visiting |  |
