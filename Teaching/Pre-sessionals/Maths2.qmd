...
<h3>Report <small><small><small>(of Maths Lecture 2)</small></small></small></h3>

-   **Introduction to Derivatives** (15 minutes)
    -   **What is a Derivative?** (7 minutes)
    ...
    -   **The Concept of Instantaneous Rate of Change** (3 minutes)
    ...
    -   **Notation and Interpretation** (5 minutes)
...
-   **Derivatives of Linear and Quadratic Functions** (15 minutes)
    -   **Finding the Derivative of Linear Functions** (7 minutes)
    ...
    -   **Finding the Derivative of Quadratic Functions** (5 minutes)
    ...
    -   **Tangent Lines and Rates of Change** (3 minutes)
...
-   **Basic Rules of Differentiation** (15 minutes)
    -   **Power Rule for Differentiation** (5 minutes)
    ...
    -   **Constant Rule and Sum Rule** (5 minutes)
    ...
    -   **Differentiating Polynomial Functions** (5 minutes)
...
-   **Applications of Derivatives** (15 minutes)
    -   **Finding Maxima and Minima** (6 minutes)
