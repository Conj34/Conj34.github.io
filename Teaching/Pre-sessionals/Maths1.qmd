...
<h3> Report <small><small><small>(of Maths Lecture 1)</small></small></small> </h3>

* **Introduction to Functions** (15 minutes)
  ...
  + **Domain and Range of a function** (5 minutes)
  ...
  + **Notation and Terminology** (5 minutes)
...
* **Polynomial Functions of Degree 2** (15 minutes)
  + **Definition of Polynomial Functions** (5 minutes)
  ...
  + **Graphing Quadratic Functions** (5 minutes)
...
* **Applications of Functions** (10 minutes)
  +   **Real-World Examples of Functions** (4 minutes)
  ...
  + **Modeling with Linear and Quadratic Functions** (3 minutes)
  ...
  + **Simple Problems Involving Functions** (3 minutes)
