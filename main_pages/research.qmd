...
|---------------|---------------|---------------|---------------|---------------|
| Methodology for carbon credit assessment | A. Perrella, G. Marastoni, D.M. | 2025+ | LSE | ![](../images/50.png){width="0.8cm"} |
| Combinatorial Theorems | P. Allen, J. Böttcher, D.M. | 2025+ | LSE | ![](../images/50.png){width="0.8cm"} |
| Partition universality for hypergraphs | P. Allen, J. Böttcher, J. Lada, D.M. | 2025+ | LSE | ![](../images/50.png){width="0.8cm"} |
| Re-ILS: a metaheuristic approach for cardinality-constrained optimization | Amazon ATS team | 2024 | Amazon | ![](../images/100.png){width="0.8cm"} |
...
| [On product Schur triples in the integers](https://arxiv.org/abs/2311.18796) | L. Mattos, D.M., O. Parczyk | 2023 | LSE | ![](../images/100.png){width="0.8cm"} |
